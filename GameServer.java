...
public class GameServer{
	...
	public static void main (String args[]) {
		try{
			...
			GameServant helloRef = new GameServant();
			...
			nc[0] = new NameComponent("Choice1", "Context");
			NamingContext RockCtx = rootCtx.bind_new_context(nc);
			System.out.println("Context 'Choice1' added to Name Space.");

			nc[0] = new NameComponent("Rock", "Object");
			//NameComponent path[] = {nc};
			//Binding the name to an object that is stored in the Naming Context
			GameCtx.rebind(nc, helloRef);
			System.out.println("Object 'Rock' added to Choice1 Context.");

			//Important!!1
			nc[0] = new NameComponent("Choice2", "Context");
			NamingContext Choice2Ctx = rootCtx.bind_new_context(nc);
			System.out.println("Context 'Choice2' added to the Name Space.");

			nc[0] = new NameComponent("Paper", "Object");
			Choice2Ctx.rebind(nc, Choice2Ctx);
			System.out.println("Object 'Paper' added to Choice2 Context.");

			nc[0] = new NameComponent("Choice3", "Context");
			NamingContext Choice3Ctx = rootCtx.bind_new_context(nc);
			System.out.println("Context 'Choice3' added to Name Space.");

			nc[0] = new NameComponent("Scissors", "Object");
			Choice3Ctx.rebind(nc, Choice3Ctx);
			System.out.println("Object 'Scissors' added to Choice3 Context.");
